...
Run (from anywhere; paths resolve off this file's location):
    python test/test_apibara_search01.py

Reads APIBARA_API_KEY from the repo-root .env, runs:
  1) Lexus ES 350, 2017-2022
  2) Audi S5,      2018-2023
prints what each lot exposes (live bid, damage, title, odometer, etc.),
and saves the full raw JSON to test_run/apibara_test_results_search01.json.
"""
import json
import os
import urllib.error
...
def main():
    ...
    out_path = OUT_DIR / "apibara_test_results_search01.json"
